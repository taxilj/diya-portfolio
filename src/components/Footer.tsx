      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-16">
          <div className="max-w-2xl text-left">
            ...
            <p className="text-xs md:text-sm text-soft-gray leading-relaxed font-normal mt-2">
              Actively seeking QA Engineer opportunities — manual, automation, API, and mobile testing roles.
            </p>
          </div>
          <p className="text-xs md:text-sm font-mono text-soft-gray mt-2 md:mt-0 select-none">
            07 // PROFESSIONAL CONNECTION
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4 text-left">
              ...
              <p className="text-xs md:text-sm text-soft-gray leading-relaxed max-w-md font-light">
                Feel free to send an email, connect on LinkedIn, or call directly. I respond within 24 hours.
              </p>
            </div>
            ...
            <div className="space-y-3 text-left">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-card-white border border-soft-gray/10 hover:shadow-2xs transition-all duration-300 group">
                <div className="flex items-center gap-3">
                  <div className="p-2.5 rounded-lg bg-soft-gray/10 text-pure-black">
                    <MapPin size={16} />
                  </div>
                  <div className="text-left">
                    <span className="block text-[8px] font-mono uppercase tracking-wider text-soft-gray font-bold">Location</span>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <span className="block text-[8px] font-mono uppercase tracking-wider text-soft-gray font-bold">LinkedIn Profile</span>
                    <span className="text-xs md:text-sm font-sans font-bold text-pure-black">Diya Patel Profile</span>
                  </div>
                </div>
                <ExternalLink size={13} className="text-soft-gray group-hover:text-pure-black transition-colors" />
              </a>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <span className="text-xs md:text-sm font-sans font-bold text-pure-black">Download Resume PDF</span>
                  </div>
                </div>
              ...
              <AnimatePresence mode="wait">
                {status !== "success" ? (
                  ...
                  >
                    ...
                    <div className="space-y-1.5 text-left">
                      <label htmlFor="footer-message" className="text-[10px] font-mono uppercase font-bold tracking-wider text-soft-gray">
                        Role Details or Message
                      </label>
                      <textarea
                        id="footer-message"
                        required
                        rows={4}
                        placeholder="Tell me about your QA role requirements, internship vacancy, or testing project..."
                  ...
                  >
                    ...
                    <h3 className="text-xl font-sans font-black text-pure-black uppercase">Message Sent!</h3>
                    <p className="text-xs md:text-sm text-soft-gray max-w-sm mx-auto leading-relaxed font-light">
                      Thank you for reaching out. I will reply to your inbox within 12–24 business hours.
                    </p>
                    <button
                      type="button"
        ...
        <div className="w-full border-t border-soft-gray/15 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-xs font-mono font-bold uppercase tracking-wider text-soft-gray">
            ...
            <a href="#education" className="hover:text-pure-black transition-colors">Education</a>
            <a href="#certifications" className="hover:text-pure-black transition-colors">Certifications</a>
            <a href="#strengths" className="hover:text-pure-black transition-colors">Strengths</a>
          </div>

          <p className="font-mono text-[10px] text-soft-gray leading-none">
            © 2026 Diya Patel. Made with React, Tailwind &amp; Framer Motion.
          </p>
