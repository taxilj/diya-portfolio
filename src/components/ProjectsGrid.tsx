...
import { X, CheckCircle, Layers, FileText, ChevronRight } from "lucide-react";
          ...
          {PROJECTS.map((project, idx) => (
            ...
            >
              <div className="relative aspect-[16/10] w-full overflow-hidden bg-bg-white border-b border-soft-gray/5">
                <img
                  src={project.image}
                  alt={`${project.title} – QA testing project by Diya Patel`}
              ...
              <div className="p-6 md:p-8 flex flex-col justify-between flex-grow space-y-6 text-left">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-[11px] font-mono font-bold uppercase tracking-wider text-soft-gray">
                    ...
                    <span className="text-[#ABC724]">QA Deliverable</span>
                  </div>
                  <h3 className="text-xl md:text-2xl font-sans font-black text-pure-black uppercase tracking-tight leading-tight">
                    {project.title}
                  </h3>
                ...
                <div className="flex items-center gap-3 p-3.5 bg-neon-lime/10 border border-neon-lime/20 rounded-xl">
                  <span className="p-1 px-2 text-[10px] font-mono font-black rounded-lg bg-pure-black text-neon-lime flex-shrink-0">
                    OUTCOME
                  </span>
          ...
          <>
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-soft-gray/10 bg-bg-white sticky top-0 z-10">
                  <div className="space-y-0.5">
                    <span className="text-[9px] font-mono font-bold tracking-widest uppercase text-soft-gray">
                      QA Testing Review // {selectedProject.category}
                    </span>
                ...
                <div className="overflow-y-auto p-5 sm:p-6 md:p-8 space-y-6 sm:space-y-8 max-h-[calc(90vh-80px)]">
                  ...
                  <div className="w-full h-48 md:h-64 rounded-2xl overflow-hidden relative shadow-inner">
                    <img
                      ...
                      alt={`${selectedProject.title} visual`}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 border-b border-soft-gray/10 pb-6 text-left">
                    <div className="p-3 bg-card-white border border-soft-gray/10 rounded-xl">
                      <span className="block text-[9px] text-soft-gray font-mono uppercase font-bold">Role</span>
                      <p className="text-xs md:text-sm font-sans font-bold text-pure-black mt-0.5">{selectedProject.role}</p>
                    </div>
                    <div className="p-3 bg-card-white border border-soft-gray/10 rounded-xl">
                      <span className="block text-[9px] text-soft-gray font-mono uppercase font-bold">Technologies</span>
                      <p className="text-xs md:text-sm font-sans font-bold text-pure-black mt-0.5">{selectedProject.tools.join(", ")}</p>
                    </div>
                    <div className="p-3 bg-neon-lime/10 border border-neon-lime/20 rounded-xl col-span-2 sm:col-span-1">
                      <span className="block text-[9px] text-pure-black font-mono uppercase font-black">Key Result</span>
                      <p className="text-xs md:text-sm font-sans font-extrabold text-pure-black mt-0.5">{selectedProject.result}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 text-left">
                    ...
                    <p className="text-xs md:text-sm text-soft-gray leading-relaxed pl-3 border-l-2 border-soft-gray/20">
                  ...
                  <div className="space-y-2 text-left">
                    <h4 className="text-xs font-mono font-bold uppercase tracking-widest text-pure-black flex items-center gap-1.5">
                      ...
                      Testing Approach &amp; Solution
                    </h4>
                    <p className="text-xs md:text-sm text-soft-gray leading-relaxed pl-3 border-l-2 border-[#ABC724]">
                  ...
                  <div className="space-y-3 pt-2 text-left">
                    <h4 className="text-xs font-mono font-bold uppercase tracking-widest text-pure-black flex items-center gap-2">
                      ...
                      Key Testing Activities &amp; Deliverables
                    </h4>
                ...
                <div className="px-6 py-4 bg-soft-gray/5 border-t border-soft-gray/10 flex justify-end sticky bottom-0">
                  <button
                    onClick={() => setSelectedProject(null)}
                    className="px-5 py-2.5 text-xs font-sans font-bold uppercase tracking-wider text-pure-black hover:bg-soft-gray/10 rounded-xl transition-all cursor-pointer"
                  >
                    Close
                  </button>
                </div>
